...
export interface DragResizableRef {
  // 최소 높이로 줄이고 드래그를 초기화한다
  minimize: () => void;
}
...
const DragResizable = forwardRef(
  (props: Props, ref: ForwardedRef<DragResizableRef>) => {
    /*
