...
export default function CalenderInner() {
  return (
    <Section>
      <ImageArea>
        <img
      ...
      <TextArea>
        <InnerTop>
          <TopTitle>
            <h1>루키(ROOKIE)</h1>
            <p>
              개발 경험이 많지 않거나 와플스튜디오에서 제공하는 세미나를 통해서{" "}
              <span>기본부터 다잡고 싶으신 분들</span>
            </p>
          </TopTitle>
          <TopDescription>
            <li>
        ...
        <InnerBottom>
          ...
          <Step>
            ...
            <StepDescription>
              ...
              <h1>루키회원 합격자 발표</h1>
              <p>
                합격자 발표는 8월 18일(금) 리쿠르팅 사이트로 공개될 예정입니다.
              </p>
            </StepDescription>
          </Step>
          <Step>
            ...
            <StepDescription>
              ...
              <p>
                8월 20일(일) 비대면으로 진행되며, 시간은 추후 공지될 예정입니다.
              </p>
            </StepDescription>
          </Step>
        </InnerBottom>
