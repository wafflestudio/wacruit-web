...
const RookieInfoTitle = styled.h2`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 30px;
...
const RookieInfoGrid = styled.div`
  display: flex;
  max-width: 1000px;
  flex-direction: column;
  align-items: center;
...
const RookieInfoMainTitle = styled.span`
...
const RookieInfoSubTitle = styled.span`
  color: var(--black-900, #121212);
  text-align: center;
...
const RookieInfoMenu = styled.div`
  display: flex;
      ...
      <RookieInfoContent>
        <RookieInfoTitle>
          ...
          <RookieInfoSubTitle>
            ...
            <p>
              Spring, FastAPI, React, Android, iOS, 총 5가지 분야의 개발
              세미나를 통해 개발의 첫 걸음을 뗄 수 있도록 지원합니다.
            </p>
          </RookieInfoSubTitle>
        </RookieInfoTitle>
        <RookieInfoGrid>
